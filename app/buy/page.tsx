...
export const metadata: Metadata = {
  ...
  description:
    "Order the Ganga Tiram book — 220 pages, 75 photographs, 75 places from Gomukh to Gangasagar. Pay by UPI, upload the confirmation, and your copy ships with tracking in 24 hours.",
